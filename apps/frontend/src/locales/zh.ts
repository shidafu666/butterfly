export const zh = {
  ...
  currentData: {
    ...
    directExport: '直接下载（使用当前查询结果）',
    directExportSuccess: '已开始下载',
    directExportSuccessDesc: '已基于当前查询结果生成并下载文件，无需再次查询数据库。',
    exportFailed: '创建导出任务失败',
    exportFailedDesc: '请检查导出参数并重试。',
    exportRangeExceeded: '导出时间范围不能超过 7 天。',
  ...
  users: {
    ...
    assignedRoles: '已分配角色',
    noAssignedRoles: '暂未分配任何角色',
    roleAssigned: '角色已分配',
    roleAssignFailed: '角色分配失败',
    roleRemoved: '角色已移除',
    roleRemoveFailed: '角色移除失败',
    confirmRemoveRole: '确认移除此角色？',
    allRolesAssigned: '所有角色均已分配',
    rolesPlaceholder: '选择角色（可多选）',
    assignSensor: '分配传感器',
    sensorPerms: '传感器权限管理',
